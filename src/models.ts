...
export const Users = sequelize.define('users', {
  ...
  wallpaper_link:          { type: Sequelize.STRING(500), allowNull: true, defaultValue: '/img/1280x960.png' },
  wallpaper_id:            { type: Sequelize.STRING(500), allowNull: true, defaultValue: '' },
